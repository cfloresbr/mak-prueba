...
<html>
	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../en/pagina-error.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">English</span></a>
								</div>
							</div>
		...
		<div class="container" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Inicio</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span>&nbsp;<span class="texto-breads">Error 404, página no encontrada</span>
		</div>
			...
			<div id="features">
				<div class="container">
					<div class="" >
						<br>
						<!-- Mensaje error -->
						<p>No se ha encontrado el contenido que estás buscando, por favor intenta nuevamente.</p>
						<br>
					</div>
					<br>
					<br>
