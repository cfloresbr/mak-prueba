...
<html>
	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../en/fuentes.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">English</span></a>
								</div>
							</div>
		...
		<div class="container" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Inicio</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span>&nbsp;<a class="breadcrums" href="equipo.php">Equipo</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i><span class="texto-breads"> Cristián Fuentes Uribe</span>
		</div>
		...
		<div class="container" style="margin-top: 70px; margin-bottom: 70px;">
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<a href="ccastillo.php"><button type="button" class="btn btn-siguiente  float-end">Siguiente<i class="fa fa-arrow-right pre" style="margin-left: 0.5rem;" aria-hidden="true"></i></button></a>
				</div>
			</div>
		</div>
