...
<html>
    ...
    <body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../en/vinculos.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">English</span></a>
								</div>
							</div>
        ...
        <!-- Portada 
		<div class="portada">
			<img width="100%" src="../img/portada-4.png">
		</div>-->

		<!-- Breadcrums -->
        <div class="container breads" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Inicio</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span><span class="texto-breads"> Vínculos</span>
		</div>
        ...
        <div id="features">
            ...
            <div id="features">
                <div class="container">
                   <div class="section_header" style="margin-top: 10px;">
                      <h3>
						<!-- Presentación -->
                        <p>
                            El Estudio cuenta con vínculos permanentes con diversos profesionales y equipos de apoyo en distintas áreas, los cuales intervienen según la naturaleza del asunto.
                        </p>
                        
                        <p>
                            Por ejemplo, peritos judiciales en ingeniería, contabilidad, mecánicos, calígrafos, documentales, aeronáuticos, geólogos, del área de la salud, como así también investigadores y seguridad.
                        </p>
                        <br>
                     </h3>
                    </div>
            ...
            <div class="greyArea pt-3 mt-4" style="padding-bottom: 4.5rem!important;">
                <div class="container">
                    <div class="carousel">
                        <div class="carousel__contenedor">
                            <!-- Botonera de vínculos -->
                            ...
                            <div class="carousel__lista" style="padding-top: 1rem!important;">
                                ...
                                <!--<div class="carousel__elemento" style="margin-right: 20px">
                                    ...
                                    <h3>Abogado Fernando Laso Rogers</h3><hr style="color: grey;">
                                    <a class="link" href=""><i class="fa fa-link pre" style="margin-right: 0.5rem;" aria-hidden="true"></i>Visita el sitio web</a>
                                </div>-->
                                <div class="carousel__elemento" style="margin-right: 20px">
		...
		<!-- Call to action -->
		<div class="call-2 mt-4">
			<div class="container" style="padding-top: 40px;">
				<h1 style="color:#fff!important;">Conoce nuestras áreas de práctica</h1><br>
				<!--<p style="color:#fff; margin-top: 20px;">Revisa las áreas de práctica de MAK Abogados.</p>-->
