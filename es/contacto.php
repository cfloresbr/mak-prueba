...
<html>
	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../en/contacto.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">En</span></a>
								</div>
							</div>
        ...
        <div class="container breads" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Inicio</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span><span class="texto-breads"> Contacto</span>
		</div><br>
	            ...
	            <div class="section_header">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
							<!-- Presentación -->
							<p>
								Gracias por contactarnos, responderemos lo antes posible a sus consultas.<br><br>
							</p>
						</div>
						<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
							<!-- Datos de contacto -->
							<p><i class="fa fa-map-marker pre" style="margin-right: 0.5rem; color: #4C0D06;" aria-hidden="true"></i>Huérfanos 835, oficina 1703, edificio Opera, Santiago</p>
						</div>
						<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 float-end" style="margin-bottom: 20px;">
				...
				<?php
					...
					<form action="./../correo.php" method="post" onsubmit="return verificarFormulario();">
						<div class="form">
							<div class="row">
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									...
									<input name="name" id="name" class="name w-100" type="text" placeholder="Su nombre">
								</div>

								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<label>Correo electrónico</label><br>
									<input name="mail" id="mail" class="mail w-100" type="email" placeholder="Su correo electrónico">
								</div>
								
								<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
									<label>Teléfono</label><br>
									<input name="phone" id="phone" class="phone w-100" type="tel" placeholder="Su teléfono" maxlength="10" onkeypress="return (event.charCode >= 48 && event.charCode <= 57)" min="1">
								<div>
						...
						<div class="col-12">
							...
							<textarea name="comentario" id="comentario" class="w-100" placeholder="Escriba la consulta..."></textarea>	
						</div>
						<p></p>
