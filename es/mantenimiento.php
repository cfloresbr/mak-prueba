...
<html>
	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../en/mantenimiento.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">English</span></a>
								</div>
							</div>
		...
		<div class="container" style="margin-top:20px">
			<a class="breadcrums" href="">Inicio</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span>&nbsp;<span class="texto-breads">Mantenimiento</span>
		</div>

		<div id="features">
			<div class="container">
				<div class="section_header" style="margin-top: 50px;">
					<!-- Título de página -->
			...
			<div id="features">
				<div class="container">
					<div class="" style="text-align: center;">
						...
						<img class="img-mantenimiento" src="../img/mak-mantenimiento.png">
						<p></p>
						<br>
					</div>
					<br>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								...
								<ul class="menu-footer">
									<li>
										<a class="footer-link" href="../es/mantenimiento.php">Inicio</a>
									</li>
