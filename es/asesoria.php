...
<html>
    ...
    <body class="pull_top" style="zoom: 1;">
        ...
        <div class="container breads" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Inicio</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span><span class="texto-breads"> Áreas de práctica</span>
		</div>
                ...
                <div class="carousel">
                    <div class="carousel__contenedor">
                        ...
                        <ul class="slider-controler">
                            <li><a href="#slide1">Materia Civil</a></li> 
                            <li><a href="#slide2">Materia Penal</a></li> 
                            <li><a href="#slide3">Materia Comercial</a></li> 
                            <li><a href="#slide4">Materia Administrativa</a></li> 
                            <li><a href="#slide5">Otras áreas</a></li>
                        </ul><br>
