...
<html>
	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../es/gacuna.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">Español</span></a>
								</div>
							</div>
		...
		<div class="container" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Home</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span>&nbsp;<a class="breadcrums" href="equipo.php">Team</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i><span class="texto-breads"> Gerardo Acuña Rivera</span>
		</div>
