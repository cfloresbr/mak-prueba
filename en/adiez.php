...
<html>
	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../es/adiez.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">Español</span></a>
								</div>
							</div>
		...
		<div class="container" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Home</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span>&nbsp;<a class="breadcrums" href="equipo.php">Team</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i><span class="texto-breads"> Alejandra Díez González</span>
		</div>
		...
		<div class="container" style="margin-top: 70px; margin-bottom: 70px;">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-bottom: 30px!important;">
					<!-- Imagen -->
					<img width="100%" src="../img/mak-vista4-2.png" style="display: block;">
				</div>

				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					<!-- Nombre y título de vista individual -->
					<h1>Alejandra Díez González</h1>
					<hr>
					<!-- Presentación -->
					<p>
					...
					<p><br></p>
					<a href="ccastillo.php"><button type="button" class="btn btn-anterior "><i class="fa fa-arrow-left pre" style="margin-right: 0.5rem;" aria-hidden="true"></i>Previous</button></a>
					<a href="forostica.php"><button type="button" class="btn btn-siguiente  float-end">Next<i class="fa fa-arrow-right pre" style="margin-left: 0.5rem;" aria-hidden="true"></i></button></a>
				</div>
			</div>
		</div>
