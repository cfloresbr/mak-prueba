...
<html>
    ...
    <body class="pull_top" style="zoom: 1;">
        ...
        <div class="container breads" style="margin-top:20px">
			<a class="breadcrums" href="index.php">Home</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span><span class="texto-breads"> Links</span>
		</div>
                ...
                <div class="container">
                   <div class="section_header" style="margin-top: 10px;">
                      <h3>
						<!-- Presentación -->
                        <p>
                            The law firm has permanent ties with various professional support teams in different areas, which are involved depending on the nature of the matter. <br><br>For example, we work with legal experts in engineering, accounting, mechanics, graphologists, documentalists, aeronautical experts, geologists, health area expert , as well as researchers and security experts.
                        </p>
                        <br>
                     </h3>
                    </div>
                        ...
                        <div class="carousel__contenedor">
                            ...
                            <div class="carousel__lista" style="padding-top: 1rem!important;">
                                <div class="carousel__elemento" style="margin-right: 20px">
									...
									<!--<hr style="color: grey;">
                                    <a class="link" href=""><i class="fa fa-link pre" style="margin-right: 0.5rem;" aria-hidden="true"></i>Go to site web</a>-->
                                </div>
                                <!--<div class="carousel__elemento" style="margin-right: 20px">
                                ...
                                <div class="carousel__elemento" style="margin-right: 20px">
                                    <img style="margin-bottom: 20px;max-height: 260px; width: 100%;" src="../img/v-auditoria.jpg">
                                    <h3>ACONSA Auditors Consultores Limitada</h3>
									<!--<hr style="color: grey;">
                                    <a class="link" href=""><i class="fa fa-link pre" style="margin-right: 0.5rem;" aria-hidden="true"></i>Go to site web</a>-->
                                </div>
                                <div class="carousel__elemento" style="margin-right: 20px">
