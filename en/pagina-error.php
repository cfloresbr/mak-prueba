...
<html>
	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../es/pagina-error.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">Español</span></a>
								</div>
							</div>
		...
		<div class="container" style="margin-top:20px">
			<a class="breadcrums" href="">Home</a>&nbsp;<span style="color:#B79E9C; font-size: 12pt;"><i style="" class="fa fa-chevron-right"></i></span>&nbsp;<span class="texto-breads">404 Error, page not found
			</span>
		</div>
			...
			<div id="features">
				<div class="container">
					<div class="" >
						<br>
						<!-- Mensaje error -->
						<p>The content you are looking for was not found, please try again.</p>
						<br>
					</div>
					<br>
					<br>
