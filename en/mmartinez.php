						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
								...
								<div class="rrss-idioma float-end" style="margin-top:14px!important;padding-bottom:;">
									...
									<a class="" href="../es/mmartinez.php"><span style="padding: 0 10px; color:#B79E9C!important;" class="combobox">Español</span></a>
								</div>
							</div>
		...
		<div class="container" style="margin-top: 70px; margin-bottom: 70px;">
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" style="margin-bottom: 30px!important;">
					<!-- Imagen -->
					<img width="100%" src="../img/mak-vista6-3.png" style="display: block;">
				</div>
