	...
	<body class="pull_top" style="zoom: 1;">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<div class="menu2 row collapse navbar-collapse float-end"  id="collapseExample">
								<ul class="nav float-end opciones-menu bottom-0">
									<li class="item-menu">
										<a href="es/index.php" class="nav-item nav-link pruebaDrupal is-active" data-drupal-link-system-path="&lt;front&gt;">Inicio</a>
									</li>
									<li class="item-menu">
										<a href="es/equipo.php" class="nav-item nav-link pruebaDrupal" data-drupal-link-system-path="puntos-de-conexion">Equipo</a>
									</li>
									<li class="item-menu">
			...
			<div class="container">
				<div class="col-12">
					<div class="row">
						...
						<div class="col-12">
							<a href="es/asesoria.php"><button type="button" class="btn btn-principal w-100"><i class="fa fa-gavel pre" style="margin-right: 0.5rem;" aria-hidden="true"></i>Conocer las áreas de práctica</button></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="call-1" style="margin-top: 40px;">
			<div class="container" style="padding-top: 40px;">
				...
				<a href="es/contacto.php"><button type="button" class="btn btn-call "><i class="fa fa-envelope pre" style="margin-right: 0.5rem;" aria-hidden="true"></i>Ir a contacto</button></a>
			</div>			
		</div>
						...
						<div class="row">
							...
							<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
								...
								<ul class="menu-footer">
									...
									<li>
										<a class="footer-link" href="es/equipo.php">Equipo</a>
									</li>
									<li>
